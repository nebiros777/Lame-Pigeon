...
// Brief description: Declares the Unreal-embedded Carrier SDK copy used by the plugin subsystem.
...
public:
    ...
    /** Lerp rate toward per-sample velocity in RunInterpolation (default 10; subsystem scales from project settings). */
